...
sed -i "/distfeeds.conf/a\echo "DISTRIB_DESCRIPTION=''ImmortalWrt 18.06 Build$(TZ=UTC-8 date "+%Y%m%d") R''" >> /etc/openwrt_release" package/emortal/default-settings/files/zzz-default-settings
