...
sed -i "25a\echo \"DISTRIB_DESCRIPTION=\'BrianLuo Compiled in $(TZ=UTC-8 date "+%Y.%m.%d") @ ImmortalWrt 18.06 \'\" >> /etc/openwrt_release" package/emortal/default-settings/files/zzz-default-settings
